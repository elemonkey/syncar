      ...
      <div className="text-center space-y-6 p-8">
        ...
        <div className="space-y-4">
          <div className="bg-gray-800/50 backdrop-blur p-6 rounded-lg border border-gray-700">
            <h2 className="text-xl font-semibold text-teal-400 mb-2">✅ Backend Configurado</h2>
            <p className="text-gray-400">FastAPI + SQLAlchemy + Celery</p>
          </div>
          <div className="bg-gray-800/50 backdrop-blur p-6 rounded-lg border border-gray-700">
            <h2 className="text-xl font-semibold text-violet-400 mb-2">⚡ Frontend Listo</h2>
            <p className="text-gray-400">Next.js 14 + Tailwind CSS</p>
          </div>
          <div className="bg-gray-800/50 backdrop-blur p-6 rounded-lg border border-gray-700">
            <h2 className="text-xl font-semibold text-emerald-400 mb-2">🐳 Docker Configurado</h2>
        ...
        <div className="mt-8 text-gray-500 text-sm">
          ...
          <p className="mt-2">API Docs (dev): <code className="text-teal-400">http://localhost:8000/docs</code></p>
        </div>
      </div>
    </div>
  )
